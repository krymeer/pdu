...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private CheckBox mRegulationsView;
    private CheckBox mRODOView;
    private CheckBox mMakretingView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegulationsView = (CheckBox) findViewById(R.id.regulations_checkbox);
        mRODOView = (CheckBox) findViewById(R.id.rodo_checkbox);
        mMakretingView = (CheckBox) findViewById(R.id.marketing_checkbox);
    ...
    private void attemptLogin() {
        ...
        mRegulationsView.setError(null);
        mRODOView.setError(null);
        mMakretingView.setError(null);
        ...
        if (!mRODOView.isChecked()) {
            mRODOView.setError(getString(R.string.error_field_required));
            focusView = mRODOView;
            cancel = true;
        }

        if (!mRegulationsView.isChecked()) {
            mRegulationsView.setError(getString(R.string.error_field_required));
            focusView = mRegulationsView;
            cancel = true;
        }

        if (!password.equals(repeatedPassword)) {
            mPasswordView.setError(getString(R.string.error_password_not_identical));
            mRepeatPasswordView.setError(getString(R.string.error_password_not_identical));
            focusView = mPasswordView;
            cancel = true;
            Log.e("pas", password + "\t" + repeatedPassword);
        }
